//
//  FavoriteApodsTableViewCell.swift
//  apod-app
//
...
class FavoriteApodsTableViewCell: UITableViewCell {
    static let identifier: String = "FavoriteApodsTableViewCell"
    ...
    func configureCell(viewModel: FavoriteApodsViewModel) {
